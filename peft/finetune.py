...
#QUANTILES=[0.0025, 0.005, 0.0075, 0.01, 0.0125, 0.025, 0.0375, 0.05, 0.075, 0.10]
QUANTILES= [ 0.00625,  0.0125, 0.01875, 0.025 ,0.10, 0.25, 0.5, 0.75, 0.9]
EPS = 1e-7
RANDOM_SEED = 1234
...
def finetune(
    *,
    ...
    tfm = TimesFm(
        ...
        quantiles=[ 0.01, 0.0125, 0.025, 0.0375, 0.05, 0.075, 0.10, 0.25, 0.5]
    )
