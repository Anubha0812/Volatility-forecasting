...
_TOL = 1e-6
#DEFAULT_QUANTILES = ( 0.01, 0.0125, 0.025, 0.0375, 0.05, 0.075, 0.10, 0.25, 0.5)
...
class TimesFmHparams:
  ...
  # quantiles: Sequence[float] = ( 0.01, 0.0125, 0.025, 0.0375, 0.05, 0.075, 0.10, 0.25, 0.5)
  quantiles: Sequence[float] = (0.00625, 0.01, 0.0125, 0.01875, 0.025, 0.25, 0.5, 0.75, 0.9)
  quantile_weights: Sequence[float] = (1, 1, 1, 1, 1, 1, 1, 1, 1)
  crossing_lambda: float = 0.
...
class TimesFmBase:
  ...
  def __init__(self, hparams: TimesFmHparams,
    ...
    self.quantile_weights = hparams.quantile_weights
    self.crossing_lambda = hparams.crossing_lambda
