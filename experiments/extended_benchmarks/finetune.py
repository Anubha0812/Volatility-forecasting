...
output_folder="log_incremental_ft"
...
#'.AEX', '.AORD', '.BFX', '.BVSP', '.DJI','.FCHI','.FTSE', '.GDAXI', '.HSI', 
       #  '.IBEX','.IXIC', '.KS11','.KSE',
#symbols=[ '.MXX', '.N225','.RUT','.SPX', '.SSEC','.SSMI','.STI','.STOXX50E']
#symbols=[ '.MXX','.RUT','.SPX', '.SSEC','.SSMI','.STI','.STOXX50E']
#symbols=['.AEX', '.AORD', '.BFX', '.BVSP', '.DJI','.FCHI','.FTSE', '.GDAXI', '.HSI', , '.KS11','.KSE','.N225',
#symbols= ['.FTSE', '.GDAXI', '.HSI', '.IBEX','.IXIC', '.KS11'] 
#symbols= ['.KSE', '.MXX', '.N225','.RUT','.SPX', '.SSEC','.SSMI','.STI','.STOXX50E'][]
symbols=[ '.N225','.RUT','.SPX', '.SSEC','.SSMI','.STI','.STOXX50E']
# '.AEX', '.AORD', '.BFX', '.BVSP', '.DJI','.FCHI','.FTSE', '.GDAXI', '.HSI', 
        #    '.IBEX','.IXIC', '.KS11','.KSE','.MXX',
# #################################################################################################################################################
...
def process_symbol(symbol):
    ...
    csv_file_path = f'{symbol_cleaned}_log_var_data.csv'
    ...
    while test_end <= total_data_points and stop <= 1:  # defin a loop that will extract the data and do the fine-turning
        ...
        CHECKPOINT_DIR = os.path.join('log_var_incre', symbol, f'iteration_{j}')
        
        # Define the directory to be removed
        if j == 3:
            target_dir = os.path.join('log_var_incre', symbol, 'iteration_1')
